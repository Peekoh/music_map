				...
				<li data-toggle="collapse" data-target="#user">
					...
					<form action="/search" class="search-form" method="get">
						<div class="search">
							...
							<input
								class="form-control transparent-input form-control-sm ml-3 w-75"
			...
			<div class="col-md-1 user-menu-btns">
				<div class="btn-group-vertical square" id="responsive">
					<a href="#" class="btn btn-block btn-default active"> <i
						class="fa fa-headphones fa-3x"></i>
					</a> <a href="#" class="btn btn-default"> <i
						class="fa fa-comment fa-3x"></i>
					</a> <a href="#" class="btn btn-default"> <i
					...
					<ul class="user-menu-list">
						...
						<%-- <li>
							<h4>
								...
								<c:out value="${history[0].name}" />
							</h4>
						</li>
						<li>
							<h4>
								<i class="fa fa-heart-o coral"></i> Drake
							</h4>
						</li>
						<li>
							<h4>
								<i class="fa fa-paper-plane-o coral"></i> Justin Bieber
							</h4>
						</li>
						<li> 
					...
					<div class="row">
						<div class="col-md-6">
							<div class="view">
								...
								<img
									src="http://24.media.tumblr.com/273167b30c7af4437dcf14ed894b0768/tumblr_n5waxesawa1st5lhmo1_1280.jpg"
						...
						<div class="col-md-6">
							<div class="view">
								...
								<img
									src="http://24.media.tumblr.com/282fadab7d782edce9debf3872c00ef1/tumblr_n3tswomqPS1st5lhmo1_1280.jpg"
									class="img-responsive">
							</div>
							<div class="info">
								<p class="small" style="text-overflow: ellipsis">An Awesome
